...
export default function UpcomingPage() {
  ...
  useEffect(() => {
    ...
    getData()
      ...
      .catch((err) => {
        console.error(err);
        SetErrorMessege("Movie api error. Failed to load upcoming movies.");
      })
      .finally(() => {
        setLoading(false);
      });
  ...
  return (
    <div className="w-full flex flex-col items-center overflow-x-hidden bg-white dark:bg-[#09090B] min-h-screen transition-colors">
      <Header />

      {/* 3. Fixed typo 'min-w7xl' to 'w-full' */}
              ...
              {data.slice(0, 10).map((object) => (
                ...
                >
                  <div className="relative w-full aspect-[2/3] bg-zinc-200 dark:bg-zinc-800">
                    {/* 4. Optimized image loading to w500 */}
                    <img
