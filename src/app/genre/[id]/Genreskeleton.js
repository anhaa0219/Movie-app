  ...
  return (
    <div className="w-full max-w-7xl flex flex-col gap-6 sm:gap-8 items-center px-4 sm:px-6 lg:px-8 mt-6 sm:mt-12 mb-8 animate-pulse">
      <div className="w-full flex">
        <div className="h-8 sm:h-9 w-44 sm:w-52 bg-zinc-200 dark:bg-zinc-800 rounded-md" />
      </div>
        ...
        <div className="w-full md:w-80 lg:w-96 flex flex-col gap-4 sm:gap-5 shrink-0">
          ...
          <div className="w-full flex flex-wrap gap-2 sm:gap-2.5 max-h-48 md:max-h-56 overflow-hidden">
            {Array.from({ length: 14 }).map((_, idx) => (
              <div
                key={idx}
                className="h-6 sm:h-7 w-16 sm:w-20 bg-zinc-200 dark:bg-zinc-800 rounded-full border border-zinc-200 dark:border-zinc-800"
              />
            ))}
          </div>
        </div>

        <div className="hidden md:flex w-px self-stretch bg-[#E4E4E7] dark:bg-zinc-800" />
        ...
        <div className="flex-1 flex flex-col gap-6 sm:gap-8">
          ...
          <div className="w-full h-10 flex justify-end">
            <div className="h-10 flex items-center gap-1">
              <div className="h-9 sm:h-10 w-20 sm:w-24 bg-zinc-200 dark:bg-zinc-800 rounded-md" />
              <div className="h-9 sm:h-10 w-9 sm:w-10 bg-zinc-200 dark:bg-zinc-800 rounded-md" />
              <div className="h-9 sm:h-10 w-9 sm:w-10 bg-zinc-200 dark:bg-zinc-800 rounded-md" />
              <div className="h-9 sm:h-10 w-9 sm:w-10 bg-zinc-200 dark:bg-zinc-800 rounded-md" />
              <div className="h-9 sm:h-10 w-9 sm:w-10 bg-zinc-200 dark:bg-zinc-800 rounded-md" />
              <div className="h-9 sm:h-10 w-16 sm:w-20 bg-zinc-200 dark:bg-zinc-800 rounded-md" />
            </div>
          </div>
        </div>
      </div>
